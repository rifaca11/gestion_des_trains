            ...
            <div class="row">
                <div class="col-md-4 foi-review mb-5 mb-md-0">
                    ...
                    <div class="media foi-review-user">
                        <img src="assets/img/avatar/avatar_11.jpg" alt="user" class="avatar">
                ...
                <div class="col-md-4 foi-review mb-5 mb-md-0">
                    ...
                    <p class="foi-review-content">Thank you for your very professional and prompt response. I wished I had found you before I spent money on a competitors theme.</p>
                    <div class="media foi-review-user">
                        <img src="assets/img/avatar/avatar_12.jpg" alt="user" class="avatar">
                        <div class="media-body">
                ...
                <div class="col-md-4 foi-review mb-5 mb-md-0">
                    ...
                    <p class="foi-review-content">Thank you for your very professional and prompt response. I wished I had found you before I spent money on a competitors theme.</p>
                    <div class="media foi-review-user">
                        <img src="assets/img/avatar/avatar_13.jpg" alt="user" class="avatar">
                        <div class="media-body">
            ...
            <div class="row">
                <div class="col-lg-6">
                    <div class="card mb-3 landing-faq-card">
                        <div class="card-header bg-white" id="faqOneTitle">
                            <a href="#faqOneCollapse" class="d-flex align-items-center" data-toggle="collapse">
                                <h6 class="mb-0">What is Rifa Train?</h6> <i class="far fa-plus-square ml-auto"></i>
                            </a>
                        </div>
                    ...
                    <div class="card mb-3 landing-faq-card">
                        <div class="card-header bg-white" id="faqTwoTitle">
                            <a href="#faqTwoCollapse" class="d-flex align-items-center" data-toggle="collapse">
                                <h6 class="mb-0">Why should I use Rifa Train</h6> <i class="far fa-plus-square ml-auto"></i>
                            </a>
                        </div>
                    ...
                    <div class="card mb-3 landing-faq-card">
                        <div class="card-header bg-white" id="faqThreeTitle">
                            <a href="#faqThreeCollapse" class="d-flex align-items-center" data-toggle="collapse">
                                <h6 class="mb-0">How can I use Rifa train</h6> <i class="far fa-plus-square ml-auto"></i>
                            </a>
                        </div>
                    ...
                    <div class="card mb-3 landing-faq-card">
                        <div class="card-header bg-white" id="faqThreeTitle">
                            <a href="#faqThreeCollapse" class="d-flex align-items-center" data-toggle="collapse">
                                <h6 class="mb-0">How can I pay ?</h6> <i class="far fa-plus-square ml-auto"></i>
                            </a>
                        </div>
                        <div id="faqThreeCollapse" class="collapse" aria-labelledby="faqThreeTitle">
                            <div class="card-body">
                    ...
                    <div class="card mb-3 landing-faq-card">
                        <div class="card-header bg-white" id="faqThreeTitle">
                            <a href="#faqThreeCollapse" class="d-flex align-items-center" data-toggle="collapse">
                                <h6 class="mb-0">How can I cancel my reservation ?</h6> <i class="far fa-plus-square ml-auto"></i>
                            </a>
                        </div>
                        <div id="faqThreeCollapse" class="collapse" aria-labelledby="faqThreeTitle">
                            <div class="card-body">
                ...
                <div class="col-lg-6">
                <img src="assets/img/quest.svg" alt="app" width="388px" class="img-fluid" >
